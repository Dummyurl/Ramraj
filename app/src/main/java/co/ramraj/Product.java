...
//			list.clear();
            ...
            json[0] = jParser.getJSONFromUrl(getResources().getString(R.string.url) + "/api/category.php?cid=" + Categories.subcatid + "&page=" + pageno);
...
//					ft.commit();
    ...
    public class AddToCartProgress extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            JSONObject[] json = new JSONObject[2];
            json[0] = jParser.getJSONFromUrl(getResources().getString(R.string.url) + "/api/addtocart.php?user_id=" + LoginId + "&product_id=" + Product_Id + "&qunt=1" + "&device_id=" + Splash.device_id);
            json[1] = jParser.getJSONFromUrl(getResources().getString(R.string.url) + "/api/cart.php?user_id=" + LoginId + "&device_id=" + Splash.device_id);
