...
public class Recents extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnrecent.setTextColor(getResources().getColor(R.color.btnactiveColor));
...
//			JSONObject json = jParser.getJSONFromUrl(getResources().getString(R.string.url)+"/api/products.php?show=recent");
            ...
            json[0] = jParser.getJSONFromUrl(getResources().getString(R.string.url) + "/api/products.php?show=recent&page=" + pageno);
